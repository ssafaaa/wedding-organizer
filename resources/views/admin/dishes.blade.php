                    ...
                    <ul class="navbar-nav flex-fill w-100 mb-2">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="collapse list-unstyled pl-4 w-100" id="ui-elements">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link pl-3" href="{{ url('admin/bridal') }}"><span
                                        ...
                                        <form action="{{ route('dishes.store') }}" method="POST"
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" id="nama_paket_dishes"
                                                        name="nama_paket_dishes">
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label for="harga_paket_dishes">Harga Paket Dishes</label>
                                                    <input type="text" class="form-control"
                                                        id="harga_paket_dishes" name="harga_paket_dishes">
                                                </div>
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input"
                                                                id="foto_dishes" name="foto_dishes">
                                                            <label class="custom-file-label" for="foto_dishes">Pilih
                                                                Foto</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="custom-file">
                                                            ...
                                                            <label class="custom-file-label" for="multiple_foto">Pilih
                                                                Foto</label>
                                                        </div>
                                                    </div>
                                                    <button type="submit"
