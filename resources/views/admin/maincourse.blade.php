              ...
              <ul class="navbar-nav flex-fill w-100 mb-2">
                <li class="nav-item dropdown">
                  ...
                  <ul class="collapse list-unstyled pl-4 w-100" id="ui-elements">
                    ...
                    <li class="nav-item">
                      <a class="nav-link pl-3" href="./ui-icons.html"><span class="ml-1 item-text">Menu Dishes</span></a>
                    </li>
                    <li class="nav-item">
      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="page-title">Main Course</h2>
              <div class="row">
                <div class="col-md-12">
                      ...
                      <form action="{{route('maincourse.store')}}" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                              <label for="nama_paket_mainC">Nama Paket Main course</label>
                              <input type="text" class="form-control" id="nama_paket_mainC" name="nama_paket_mainC">
                            </div>
                              <div class="form-group col-md-12">
                                <label for="harga_paket_mainC">Harga Paket Main course</label>
                                <input type="text" class="form-control" id="harga_paket_mainC" name="harga_paket_mainC">
                              </div>
                              <div class="col-md-12">
                                            ...
                                            <table class="table datatables" id="dataTable-1">
                                                ...
                                                <tbody>
                                                    @foreach ($maincourses as $mc)
                                                        <tr>
                                                            <td>{{ $mc->id_maincourse }}</td>
                                                            <td>{{ $mc->nama_paket_mainC }}</td>
                                                            <td>{{ $mc->harga_paket_mainC }}</td>
                                                            <td><span
                                                                    class="text-muted sr-only">Action</span>
                                                                    <button type="button"
                                                                    data-target="#verticalModal{{ $mc->id_maincourse }}"
                                                                    data-toggle="modal"
