      ...
      <main role="main" class="main-content">
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-12">
              <h2 class="page-title">Dokumentasi</h2>
              <div class="row">
                <div class="col-md-12">
                      ...
                      <form action="{{route('dokumentasi.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                              ...
                              <input type="text" class="form-control" id="nama_paket_dokumentasi" name="nama_paket_dokumentasi">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="jenis_dokumentasi">Jenis Dokumentasi</label>
                                <select id="jenis_dokumentasi" class="form-control" name="jenis_dokumentasi">
                              ...
                              <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="harga_dokumentasi" name="harga_dokumentasi">
                              </div>
                              <div class="col-md-12">
                                <div class="form-group">
                                    <label for="example-textarea">Deskripsi</label>
                                    <textarea class="form-control" id="deskripsi_dokumentasi" rows="2" name="deskripsi_dokumentasi"></textarea>
                                  </div>
                              <label for="customFile">Foto Thumbnail</label>
                              <div class="custom-file">
                                  <input type="file" class="custom-file-input"
                                      id="foto_dokumentasi" name="foto_dokumentasi">
                                  <label class="custom-file-label" for="foto_dokumentasi">Choose
                                      file</label>
                              </div>
                              <br><br>
                                            ...
                                            <table class="table datatables" id="dataTable-1">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Nama Paket Dokumentasi</th>
                                                        <th>Harga Dokumentasi</th>
                                                        <th>Aksi</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    @foreach ($dokumentasis as $dok)
                                                        <tr>
                                                            <td>{{ $dok->id_dokumentasi }}</td>
                                                            <td>{{ $dok->nama_paket_dokumentasi }}</td>
                                                            <td>{{ $dok->harga_dokumentasi }}</td>
                                                            <td><span
                                                                    class="text-muted sr-only">Action</span>
                                                                <button type="button"
                                                                    data-target="#verticalModal{{ $dok->id_dokumentasi }}"
                                                                    data-toggle="modal"
                                                                ...
                                                                <button type="button"
                                                                    data-target="#varyModal{{ $dok->id_dokumentasi }}"
                                                                    data-toggle="modal"
            ...
            <div
            class="modal fade"
            id="varyModal{{ $dok->id_dokumentasi }}"
            tabindex="-1"
            role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="varyModalLabel">Edit dokumentasi</h5>
                        <button
                            type="button"
                            class="close"
                            data-dismiss="modal"
                    ...
                    <div class="modal-body">
                        <form
                            action="{{ route('dokumentasi.update', $dok->id_dokumentasi) }}"
                            method="POST"
                            ...
                            <!-- Nama dokumentasi -->
                            <div class="form-group">
                                <label for="nama_paket_dokumentasi" class="col-form-label">Nama paket dokumentasi:</label>
                                <input
                                    type="text"
                                    class="form-control"
                                    id="nama_paket_dokumentasi"
                                    name="nama_paket_dokumentasi"
                                    value="{{ $dok->nama_paket_dokumentasi }}">
                            </div>

                            <!-- Jenis Dokumentasi -->
                            <div class="form-group">
                                <label for="jenis_dokumentasi" class="col-form-label">Jenis Dokumentasi:</label>
                                <select id="jenis_dokumentasi" class="form-control" name="jenis_dokumentasi">
                            ...
                            <!-- Harga dokumentasi -->
                            <div class="form-group">
                                <label for="harga_dokumentasi" class="col-form-label">Harga Sewa dokumentasi:</label>
                                <input
                                    type="text"
                                    class="form-control"
                                    id="harga_dokumentasi"
                                    name="harga_dokumentasi"
                                    value="{{ $dok->harga_dokumentasi }}">
                            </div>

                            <!-- Deskripsi dokumentasi -->
                            <div class="form-group">
                                <label for="deskripsi_dokumentasi" class="col-form-label">Deskripsi:</label>
                                <textarea
                                    class="form-control"
                                    id="deskripsi_dokumentasi"
                                    name="deskripsi_dokumentasi">{{ $dok->deskripsi_dokumentasi }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="foto_dokumentasi">Pilih Foto</label>
                                </div>
                            </div>
...
<!-- Modal -->
<div class="modal fade" id="verticalModal{{ $dok->id_dokumentasi }}" tabindex="-1" role="dialog" aria-labelledby="verticalModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="verticalModalTitle">Detail dokumentasi</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <h5>ID dokumentasi: {{ $dok->id_dokumentasi }}</h5>
                <h5>Nama dokumentasi: {{ $dok->nama_paket_dokumentasi }}</h5>
                <h5>Jenis dokumentasi: {{ $dok->jenis_dokumentasi }}</h5>
                <h5>Harga dokumentasi: {{ $dok->harga_dokumentasi }}</h5>
                <h5>Deskripsi dokumentasi: {{ $dok->deskripsi_dokumentasi }}</h5>

                <!-- Foto Thumbnail -->
                <h5>Foto Thumbnail dokumentasi:</h5>
                <img src="{{ asset('storage/' . $dok->foto_dokumentasi) }}" alt="Foto Thumbnail dokumentasi" class="img-thumbnail" style="width: 100%; max-width: 300px;">

                <!-- Foto Lainnya -->
                <h5>Foto Lainnya:</h5>
                <div class="d-flex flex-wrap">
                    @forelse ($dok->dokumentasiImages as $image) <!-- Pastikan relasi `dokumentasiImages` sudah diatur di model dokumentasi -->
                        <img src="{{ asset('storage/' . $image->image_path) }}" alt="Foto Lainnya" class="img-thumbnail m-2" style="width: 100px; height: auto;">
                    @empty
