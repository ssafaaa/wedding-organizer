                                        ...
                                        <form action="{{ route('dekorasi.store') }}" method="POST"
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" id="nama_dekorasi"
                                                        name="nama_dekorasi">
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label for="harga_dekorasi">Harga Dekorasi</label>
                                                    <input type="text" class="form-control" id="harga_dekorasi"
                                                        name="harga_dekorasi">
                                                </div>
                                                <div class="col-md-12">
                                                            ...
                                                            <tbody>
                                                                @forelse ($dekorasis as $dk)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ number_format($dk->harga_dekorasi, 0, ',', '.') }}
                                                                        </td>
                                                                        <td>
                                                                            <button type="button"
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <form
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <textarea class="form-control" id="deskripsi_dekorasi" name="deskripsi_dekorasi">{{ $dk->deskripsi_dekorasi }}</textarea>
                                                                                        </div>
                                                                    ...
                                                                    <!-- Modal -->
                                                                    <div class="modal fade"
                                                                        id="verticalModal{{ $dk->id_dekorasi }}"
                                                                        tabindex="-1" role="dialog"
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <div class="flex-wrap d-flex">
                                                                                        @forelse ($dk->dekorasiImages as $image)
