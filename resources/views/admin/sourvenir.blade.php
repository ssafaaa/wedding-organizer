                    ...
                    <ul class="mb-2 navbar-nav flex-fill w-100">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="pl-4 collapse list-unstyled w-100" id="ui-elements">
                                ...
                                <li class="nav-item">
                                    <a class="pl-3 nav-link" href="./ui-typograpy.html"><span
                                            class="ml-1 item-text">Menu Main Course</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="pl-3 nav-link" href="./ui-icons.html"><span class="ml-1 item-text">Menu
                                            Dishes</span></a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="pl-3 nav-link" href="./ui-tabs-accordion.html"><span
                                            class="ml-1 item-text">Undangan</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="pl-3 nav-link" href="./ui-progress.html"><span
        ...
        <main role="main" class="main-content">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12">
                        <h2 class="page-title">Sourvenir</h2>
                        <div class="row">
                            <div class="col-md-12">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        id="nama_paket_sourvenir" name="nama_paket_sourvenir">
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label for="harga_sourvenir">Harga Sourvenir</label>
                                                    <input type="text" class="form-control" id="harga_sourvenir"
                                                        name="harga_sourvenir">
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="example-textarea">Deskripsi</label>
                                                        <textarea class="form-control" id="deskripsi_sourvenir" rows="2" name="deskripsi_sourvenir"></textarea>
                                                    </div>
                                                    <label for="customFile">Foto Thumbnail</label>
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input"
                                                            id="foto_sourvenir" name="foto_sourvenir">
                                                        <label class="custom-file-label" for="foto_sourvenir">Choose
                                                            file</label>
                                                    </div>
                                                    <br><br>
                                    ...
                                    <div class="col-12">
                                        <div class="my-4 row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="shadow card">
                                                    <div class="card-body">
                                                        <!-- Search Form -->
                                                        <form action="{{ route('sourvenir') }}" method="GET">
                                                        ...
                                                        <table class="table datatables" id="dataTable-1">
                                                            <thead>
                                                                <tr>
                                                                    <th>ID Sourvenir</th>
                                                                    <th>Nama Sourvenir</th>
                                                                    <th>Harga Sourvenir</th>
                                                                    <th>Aksi</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                @foreach ($sourvenirs as $sv)
                                                                    <tr>
                                                                        ...
                                                                        <td><span
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            <form
                                                                                                ...
                                                                                                <div
                                                                                                    class="form-group">
                                                                                                    <label
                                                                                                        for="deskripsi_sourvenir"
                                                                                                        class="col-form-label">Deskripsi:</label>
                                                                                                    <textarea class="form-control" id="deskripsi_sourvenir" name="deskripsi_sourvenir">{{ $sv->deskripsi_sourvenir }}</textarea>
                                                                                                </div>
                                                                            ...
                                                                            <!-- Modal -->
                                                                            <div class="modal fade"
                                                                                id="verticalModal{{ $sv->id_sourvenir }}"
                                                                                tabindex="-1" role="dialog"
                                                                                ...
                                                                                <div class="modal-dialog modal-dialog-centered"
                                                                                    ...
                                                                                    <div class="modal-content">
                                                                                        ...
                                                                                        <!-- Foto Thumbnail -->
                                                                                        <h5>Foto Thumbnail dekorasi:
                                                                                        </h5>
                                                                                        <img src="{{ asset('storage/' . $sv->foto_sourvenir) }}"
                                                                                        ...
                                                                                        <div class="flex-wrap d-flex">
                                                                                            @forelse ($sv->sourvenirImages as $image)
                                                                                        ...
                                                                                        <div class="modal-footer">
                                                                                            <button type="button"
                                                                                                ...
                                                                                                data-dismiss="modal">Close</button>
                                                                                            {{-- <button type="button" class="mb-2 btn btn-primary">Save changes</button> --}}
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                        ...
                                        <div class="modal fade modal-notif modal-slide" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog modal-sm" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="defaultModalLabel">Notifications
                                                        </h5>
                                                            ...
                                                            <div class="bg-transparent list-group-item">
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="my-0 text-muted small">Package is
                                                                            zipped and uploaded</div>
                                                                        <small
                                                                            class="badge badge-pill badge-light text-muted">1m
                                                                            ago</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col">
                                                                        <small><strong>Widgets are updated
                                                                                successfull</strong></small>
                                                                        <div class="my-0 text-muted small">Just create
                                                                            new layout Index, form, table</div>
                                                                        <small
                                                                            class="badge badge-pill badge-light text-muted">2m
                                                                            ago</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="my-0 text-muted small">Fusce
                                                                            dapibus, tellus ac cursus commodo</div>
                                                                        <small
                                                                            class="badge badge-pill badge-light text-muted">30m
                                                                            ago</small>
                                                                    </div>
                                                                </div> <!-- / .row -->
                                                            </div>
                                                                ...
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col">
                                                                        <small><strong>Link was attached to
                                                                                menu</strong></small>
                                                                        <div class="my-0 text-muted small">New layout
                                                                            has been attached to the menu</div>
                                                                        <small
                                                                            class="badge badge-pill badge-light text-muted">1h
                                                                            ago</small>
                                                                    </div>
                                                                </div>
                                                            </div> <!-- / .row -->
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="text-center col-6">
                                                                <div
                                                                    ...
                                                                    <i
                                                                        class="text-white fe fe-cpu fe-32 align-self-center"></i>
                                                                </div>
                                                                <p>Control area</p>
                                                            </div>
                                                            <div class="text-center col-6">
                                                                <div
                                                                    ...
                                                                    <i
                                                                        class="text-white fe fe-activity fe-32 align-self-center"></i>
                                                                </div>
                                                                <p>Activity</p>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center">
                                                            <div class="text-center col-6">
                                                                <div
                                                                    class="squircle bg-primary justify-content-center">
                                                                    <i
                                                                        class="text-white fe fe-droplet fe-32 align-self-center"></i>
                                                                </div>
                                                                <p>Droplet</p>
                                                            </div>
                                                            <div class="text-center col-6">
                                                                <div
                                                                    class="squircle bg-primary justify-content-center">
                                                                    <i
                                                                        class="text-white fe fe-upload-cloud fe-32 align-self-center"></i>
                                                                </div>
                                                                <p>Upload</p>
                                                            </div>
                                                        </div>
                                                        <div class="row align-items-center">
                                                            <div class="text-center col-6">
                                                                <div
                                                                    class="squircle bg-primary justify-content-center">
                                                                    <i
                                                                        class="text-white fe fe-users fe-32 align-self-center"></i>
                                                                </div>
                                                                <p>Users</p>
                                                            </div>
                                                            <div class="text-center col-6">
                                                                <div
                                                                    class="squircle bg-primary justify-content-center">
                                                                    <i
                                                                        class="text-white fe fe-settings fe-32 align-self-center"></i>
                                                                </div>
                                                                <p>Settings</p>
                                                            </div>
                                                        </div>
