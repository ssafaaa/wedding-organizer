                      ...
                      <form action="{{route('bridalstyle.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                              ...
                              <input type="text" class="form-control" id="nama_bridalstyle" name="nama_bridalstyle">
                            </div>
                              <div class="form-group col-md-12">
                                <label for="harga_bridalstyle">Harga Dekorasi</label>
                                <input type="text" class="form-control" id="harga_bridalstyle" name="harga_bridalstyle">
                              </div>
                              <div class="col-md-12">
                ...
                <tbody>
                    @forelse ($bridalstyles as $dk)
                        <tr>
                            ...
                            <td>{{ number_format($dk->harga_bridalstyle, 0, ',', '.') }}</td>
                            <td>
                                <button type="button" data-target="#verticalModal{{ $dk->id_bridalstyle }}" data-toggle="modal" class="btn mb-2 btn-primary">
                                    <span class="fe fe-20 fe-eye"></span>
                                </button>
                                <button type="button" data-target="#varyModal{{ $dk->id_bridalstyle }}" data-toggle="modal" class="btn mb-2 btn-warning">
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <form
                                                                                        ...
                                                                                        <!-- Harga Dekorasi -->
                                                                                        <div class="form-group">
                                                                                            <label for="harga_bridalstyle" class="col-form-label">Harga Sewa Dekorasi:</label>
                                                                                            <input
                                                                                                type="text"
                                                                                                class="form-control"
                                                                                        ...
                                                                                        <!-- Deskripsi dekorasi -->
                                                                                        <div class="form-group">
                                                                                            <label for="deskripsi_bridalstyle" class="col-form-label">Deskripsi:</label>
                                                                                            <textarea
                                                                                                class="form-control"
                                                                                                id="deskripsi_bridalstyle"
                                                                                                name="deskripsi_bridalstyle">{{ $dk->deskripsi_bridalstyle }}</textarea>
                                                                                        </div>

                                                                                        <!-- Foto dekorasi -->
                                                                                        <div class="form-group">
                                                                                            <label for="foto_bridalstyle">Foto dekorasi</label>
                                                                                            <div class="custom-file">
                                                                                                <input
                                                                                                    type="file"
                                                                                                ...
                                                                                                <label class="custom-file-label" for="foto_bridalstyle">Pilih Foto</label>
                                                                                            </div>
                                                                                        </div>
...
<!-- Modal -->
<div class="modal fade" id="verticalModal{{ $dk->id_bridalstyle }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h5>ID dekorasi: {{ $dk->id_bridalstyle }}</h5>
                <h5>Nama dekorasi: {{ $dk->nama_bridalstyle }}</h5>
                <h5>Harga dekorasi: {{ $dk->harga_bridalstyle }}</h5>
                <h5>Deskripsi dekorasi: {{ $dk->deskripsi_bridalstyle }}</h5>

                <!-- Foto Thumbnail -->
                <h5>Foto Thumbnail dekorasi:</h5>
                <img src="{{ asset('storage/' . $dk->foto_bridalstyle) }}" alt="Foto Thumbnail dekorasi"
                    class="img-thumbnail" style="width: 100%; max-width: 300px;">

                <!-- Foto Lainnya -->
                <h5>Foto Lainnya:</h5>
                <div class="d-flex flex-wrap">
                    @forelse ($dk->bridalImages as $image) <!-- Pastikan relasi `dekorasiImages` sudah diatur di model dekorasi -->
