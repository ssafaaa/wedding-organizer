        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 p-b-30">
                <div class="team-member">
                    <div class="hov-img0">
                        <img src="{{ asset('cst/booking/images/team-1.jpg') }}" alt="Nathan">
                    </div>
                    <div class="p-t-10 txt-center">
                        <h5 class="mtext-112 cl2">Nathan</h5>
                        <span class="stext-111 cl6">Project Manager</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4 p-b-30">
                <div class="team-member">
                    <div class="hov-img0">
                        <img src="{{ asset('cst/booking/images/team-2.jpg') }}" alt="Safa">
                    </div>
                    <div class="p-t-10 txt-center">
                        <h5 class="mtext-112 cl2">Safa</h5>
                        <span class="stext-111 cl6">Personal Assistant</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4 p-b-30">
                <div class="team-member">
                    <div class="hov-img0">
                        <img src="{{ asset('cst/booking/images/team-3.jpg') }}" alt="Bella">
                    </div>
                    <div class="p-t-10 txt-center">
                        <h5 class="mtext-112 cl2">Bella</h5>
                        <span class="stext-111 cl6">Stage Manager</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4 p-b-30">
                <div class="team-member">
                    <div class="hov-img0">
                        <img src="{{ asset('cst/booking/images/team-4.jpg') }}" alt="Anastasia">
                    </div>
                    <div class="p-t-10 txt-center">
                        <h5 class="mtext-112 cl2">Anastasia</h5>
                        <span class="stext-111 cl6">Personal Assistant</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4 p-b-30">
                <div class="team-member">
                    <div class="hov-img0">
                        <img src="{{ asset('cst/booking/images/team-5.jpg') }}" alt="Raquel">
                    </div>
                    <div class="p-t-10 txt-center">
                        <h5 class="mtext-112 cl2">Raquel</h5>
                        <span class="stext-111 cl6">Stage Manager</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4 p-b-30">
                <div class="team-member">
                    <div class="hov-img0">
                        <img src="{{ asset('cst/booking/images/team-6.jpg') }}" alt="Verdonk">
                    </div>
                    <div class="p-t-10 txt-center">
                        <h5 class="mtext-112 cl2">Verdonk</h5>
                        <span class="stext-111 cl6">Production Team</span>
                    </div>
                </div>
            </div>
        </div>
