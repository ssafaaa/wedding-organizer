...
<body class="bg-gray-100">
    <h3 class="mtext-111 cl2 p-b-16 txt-center">
        Pasangan ini telah mencapai kebahagiaan selamanya
    </h3>
    <p class="stext-113 cl6 p-b-26 txt-center">
        Berkat usaha yang tak henti-hentinya untuk saling memahami, menghormati, dan menjaga komitmen, bahkan di tengah perbedaan yang kadang muncul, mereka berhasil menemukan kebahagiaan sejati dalam kehidupan bersama.
    </p>
  <!-- Gallery Section -->
  <section class="py-10">
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <div class="relative">
          <img
            src="{{ asset('cst/booking/images/woslide-1.jpg') }}"
            alt="Gallery Item"
          ...
          <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity rounded-lg">
            <p class="text-white text-center font-semibold">Hardin & Tessa</p>
          </div>
        </div>
        <!-- Duplicate the gallery item -->
        <div class="relative">
          <img
            src="{{ asset('cst/booking/images/woslide-1.jpg') }}"
            alt="Gallery Item"
          ...
          />
          <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity rounded-lg">
            <p class="text-white text-center font-semibold">Nathan & Fefe</p>
          </div>
        </div>
        ...
        <div class="relative">
            ...
            />
            <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity rounded-lg">
              <p class="text-white text-center font-semibold">Jay & Pien</p>
            </div>
          </div>
