...
<body class="animsition">
                    ...
                    <div class="menu-desktop">
                        <ul class="main-menu">
                            ...
                            <li class="active-menu">
                                <a href="{{ route('user.booking') }}">Shop</a>
                            </li>
        ...
        <div class="container">
            <div class="flex-w flex-sb-m p-b-52">
                <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                    <button
                        class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 how-active1 {{ session()->has('gedung_terpilih') ? 'disabled' : '' }}"
                        data-filter=".gedung">
                        Gedung
                    </button>
                    <button
                        class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 {{ session()->has('dekorasi_terpilih') ? 'disabled' : '' }}"
                        data-filter=".dekorasi">
                        Dekorasi
                    </button>
                    <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 {{ session()->has('undangan_terpilih') ? 'disabled' : '' }}" data-filter=".undangan">
                        Undangan
                    </button>
                    <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".katering">
                        Katering
                    </button>
                    <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".bridalstyle">
                        Bridalstyle
                    </button>
                    <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 {{ session()->has('hiburan_terpilih') ? 'disabled' : '' }}" data-filter=".hiburan">
                        Hiburan
                    </button>
                    <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 {{ session()->has('dokumentasi_terpilih') ? 'disabled' : '' }}" data-filter=".dokumentasi">
                        Dokumentasi
                    </button>
                    <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 {{ session()->has('sourvenir_terpilih') ? 'disabled' : '' }}" data-filter=".sourvenir">
                        Sourvenir
                    </button>
                </div>
            </div>
            ...
            <!-- Kategori Item -->
            <div class="isotope-grid gedung">
                @include('user.components.gedung')
            </div>
            <div class="isotope-grid dekorasi">
                @include('user.components.dekorasi')
            </div>
            <div class="row isotope-grid dokumentasi">
                @include('user.components.dokumentasi')
            </div>
            <div class="row isotope-grid hiburan">
    ...
    <script src="/cst/booking/js/slick-custom.js"></script>
    <!--===============================================================================================-->
    ...
    <!--===============================================================================================-->
    <script src="/cst/booking/js/main.js"></script>
